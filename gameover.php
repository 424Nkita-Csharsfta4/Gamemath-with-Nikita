...
<head>
    ...
    <title>Выход из игры!</title>
</head>
<body>
    <p>Спасибо что уделили нам время куда хотите вернуться?</p>
    <a href="index.php">Главная</a>
    <br>
    <a href="login.php">Авторизация</a>
    <br>
    <a href="igra.php">Заного пройти игру</a>
    <br>
    <a href="main.php">Остальные задачи</a>
</body>
